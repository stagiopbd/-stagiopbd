    ...
    <body>
        ...
        <div id="line-one">
            <div class="container">
                ...
                <div class="row">  
                    <br>
                    <h4 id="center"><b>CADASTRO DE TIPO DE EXAME</b></h4>
                    <br> 
                    <form method="post" 
                          action="{{route('tipoexame.store')}}" 
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="detalhes_exame" rows="3"></textarea>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="param_inicial_input">Parâmetro Inicial</label>
                                <input type="range" name="param_inicial_input" id="param_inicial_input_id" value="0" min="0" max="1" step=0.1 oninput="param_inicial_output_id.value = param_inicial_input_id.value" 
                                       class="form-control" 
                                       required>
                                <output name="param_inicial_output" id="param_inicial_output_id">0</output>
                            </div>    
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="param_final_input">Parâmetro Final</label>
                                <input type="range" name="param_final_input" id="param_final_input_id" value="0" min="0" max="1" step=0.1 oninput="param_final_output_id.value = param_final_input_id.value" 
                                       class="form-control" 
                                       required>
                                <output name="param_final_output" id="param_final_output_id">0</output>
                            </div>    
                        </div>                               
                        <div class="col-md-12">                   
